...
$.audio.sounds = {
    click: [new Howl({
        src: ["./sounds/click-0.webm", "./sounds/click-0.mp3"],
        pool: 50
    })],
    death: [new Howl({
        src: ["./sounds/death-0.webm", "./sounds/death-0.mp3"],
        pool: 50
    ...
    hit: [
        new Howl({
            src: ["./sounds/hit-0.webm", "./sounds/hit-0.mp3"],
            pool: 50
        }),
        new Howl({
            src: ["./sounds/hit-1.webm", "./sounds/hit-1.mp3"],
            pool: 50
        }),
        new Howl({
            src: ["./sounds/hit-2.webm", "./sounds/hit-2.mp3"],
            pool: 50
        }),
    ],
    hover: [new Howl({
        src: ["./sounds/hover-0.webm", "./sounds/hover-0.mp3"],
        pool: 50
    })],
    levelup: [
        new Howl({
            src: ["./sounds/levelup-0.webm", "./sounds/levelup-0.mp3"],
            pool: 50
        }),
    ],
    powerup: [
